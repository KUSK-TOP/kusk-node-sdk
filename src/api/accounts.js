/**
 * An account is an object in Kusk that tracks ownership of assets on a
 * blockchain.
 *
 ...
 *
 * @property {String} id
 * Unique account identifier in one Kusk node.
 *
...
const accountsApi = (connection) => {
  ...
  return {
    ...
    /**
     * List all accounts in the target Kusk node.
     *
